...
namespace EasyADO.NET
{
    public partial class EasyAdoNet
    {
        ...
        /// <returns>A <see cref="SqlDataReader"/>.</returns>
        /// <exception cref="ArgumentException">Throws, when given table name doesn't exist in the database or predicate is empty.</exception>
        ...
        public SqlDataReader Find(string tableName, string predicate)
        {
            CheckForTableExistent(tableName);
